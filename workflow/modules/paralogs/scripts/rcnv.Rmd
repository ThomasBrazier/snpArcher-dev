...
# Filtering samples
head(mss$perSample)
sam  = which(mss$perSample$f_miss > maxMissSample) + 9 # here we determine the sample columns with f_miss > max missingness and add 9 to get the correct column number because there are 9 more columns before the sample columns start.
